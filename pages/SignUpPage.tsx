    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mt-2">Join WellNest Today</h1>
            <p className="text-gray-300">Start your journey towards well-being.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2">
                <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                >
                    {isLoading ? <Spinner size="6" /> : "Create Account"}
                </motion.button>
            </div>
        </form>
